...
function addMargin(result, options) {
  ...
  var translateX = viewBox.width * options.margin / 100;
  var translateY = viewBox.height * options.margin / 100;
  var scale = 1 - options.margin * 2 / 100;
  var rectWidth = viewBox.width.toString();
  var rectHeight = viewBox.height.toString();
  var rectX = viewBox.x.toString();
  var rectY = viewBox.y.toString();
  return "\n<g transform=\"".concat("translate(".concat(translateX, ", ").concat(translateY, ")"), "\">\n<g transform=\"", "scale(".concat(scale, ")"), "\">\n<rect fill=\"none\" width=\"", rectWidth, "\" height=\"").concat(rectHeight, "\" x=\"").concat(rectX, "\" y=\"").concat(rectY, "\" />\n").concat(result.body, "\n</g>\n</g>\n");
}
function addBackgroundColor(result, options) {
  var viewBox = getViewBox(result);
  var width = viewBox.width.toString();
  var height = viewBox.height.toString();
  var x = viewBox.x.toString();
  var y = viewBox.y.toString();
  return "\n<rect fill=\"".concat(options.backgroundColor, "\" width=\"").concat(width, "\" height=\"").concat(height, "\" x=\"").concat(x, "\" y=\"").concat(y, "\" />\n").concat(result.body, "\n");
}
function addRadius(result, options) {
  ...
  var width = viewBox.width.toString();
  var height = viewBox.height.toString();
  var rx = (viewBox.width * options.radius / 100).toString();
  var ry = (viewBox.height * options.radius / 100).toString();
  var x = viewBox.x.toString();
  var y = viewBox.y.toString();
...
function createAvatar(style) {
  var _result$head, _result$head2;
