...
export const profileSectionBackground = (state = 4, action) => {
    switch (action.type) {
        case "setBackground":
            return action.payload;
        default:
...
export const profileSectionBackgroundColor = (state = "aqua", action) => {
    switch (action.type) {
...
export const UsernameP = (state = "Anonymouse", action) => {
    switch (action.type) {
        case "usernamep":
            return action.payload;
        default:
...
export const DescribeP = (state = "I think i like to stay Anonimous", action) => {
    switch (action.type) {
        case "describep":
            return action.payload;
        default:
...
export const AddressP = (state = "Ha-Ha Road, London, UK", action) => {
    switch (action.type) {
        case "addressp":
            return action.payload;
        default:
...
export const UsernameFontP = (state = "Ubuntu", action) => {
    switch (action.type) {
        case "usernamefontp":
            return action.payload;
        default:
...
export const DescribeFontP = (state = "Nunito", action) => {
    switch (action.type) {
        case "describefontp":
            return action.payload;
        default:
...
export const AddressFontP = (state = "Nunito", action) => {
    switch (action.type) {
        case "addressfontp":
            return action.payload;
        default:
...
export const UsernameColorP = (state = "#000000", action) => {
    switch (action.type) {
        case "usernamecolorp":
            return action.payload;
        default:
...
export const DescribeColorP = (state = "#000000", action) => {
    switch (action.type) {
        case "describecolorp":
            return action.payload;
        default:
...
export const AddressColorP = (state = "#000000", action) => {
    switch (action.type) {
        case "addresscolorp":
            return action.payload;
        default:
...
export const alignp = (state = "left", action) => {
    switch (action.type) {
        case "alignp":
            return action.payload;
        default:
