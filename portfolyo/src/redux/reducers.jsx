...
export const skillsSection = (
    state = portfolyodata.skillsSection || {
        ...
        skillsSectionPara: {
            text: "I'm good at the following skills, but I'm a beginner minded person, so I try to gain more and more expretise!",
            color: "#404040",
            fontStyle: "Ubuntu",
            alignment: "center",
        },
    ...
    switch (action.type) {
        ...
        case "skillsSectionParaChangeText":
            return (state = {
                ...state,
                skillsSectionPara: {
                    ...state.skillsSectionPara,
                    text: action.payload,
                },
            });
        ...
        case "skillsSectionParaChangeColor":
            return (state = {
                ...state,
                skillsSectionPara: {
                    ...state.skillsSectionPara,
        ...
        case "skillsSectionParaChangeFontStyle":
            return (state = {
                ...state,
                skillsSectionPara: {
                    ...state.skillsSectionPara,
