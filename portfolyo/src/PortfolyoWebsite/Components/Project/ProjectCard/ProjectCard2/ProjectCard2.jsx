  ...
  try {
    return (
      <div className="projectcard1 mb-0 pb-0 mx-auto" style={{width:"max-content"}} data-aos={props.data.animation} data-aos-delay={new Number(props.data.delay)*1000} data-aos-duration={new Number(props.data.duration)*1000}  data-aos-offset="250">
        ...
        <div id={`titlecontent${props.data.index}`} className="titlecontent">
        ...
        <IconButton style={{display:"block",marginLeft:"auto",marginRight:"auto",transform:(rotate===true)?"rotate(180deg)":"rotate(0deg)"}} onClick={()=>togglediv(`#titlecontent${props.data.index}`)}>
            <ExpandMoreIcon/>
          </IconButton>
        </div>
      </div>
