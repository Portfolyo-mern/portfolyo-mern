...
let Header2 = (props) => {
    ...
    return (
        <div className="Header2 m-0">
            <nav
                id="scrollNavbar"
                class="navbar my-0 py-2 navbar-fixed-top  navbar-expand-lg navbar-dark fixed-top"
                style={{
                    postion: "sticky",
                    ...
                    <ul class="navbar-nav ml-auto py-0 my-0">
                        {props.menu.map((ele) => (
                            ...
                            >
                                {/* eslint-disable-next-line */}
                                <a
                                    class="nav-link stroke  text-center"
