                  ...
                  <Button
                    ...
                    onClick={() => {
                      dispatch({
                        type: "setnavbar",
                        payload:
                          document.querySelector("#Editorsetnavbar").value,
                      });
                      dispatch({
                        type: "setabout",
                        payload:
                          document.querySelector("#Editorsetabout").value,
                      });
                      dispatch({
                        type: "sethome",
                        payload:
                          document.querySelector("#Editorsetskills").value,
                      });
                      dispatch({
                        type: "setarticle",
                        payload: document.querySelector("#Editorseteducation")
                          .value,
                      });
                      dispatch({
                        type: "setproject",
                        payload:
                          document.querySelector("#Editorsetproject").value,
                      });
                      dispatch({
                        type: "setcontact",
                        payload:
                          document.querySelector("#Editorsetcontact").value,
                      });
                    }}
                  >
                    Apply text
