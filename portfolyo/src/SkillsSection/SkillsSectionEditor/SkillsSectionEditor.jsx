...
const SkillsSectionEditor = () => {
	...
	const [
		skillsLayoutBackgroundSelected,
		setskillsLayoutBackgroundSelected,
	...
	//backgoundColor
	const [skillsSectionBackgroundColor, setlayoutBackgroundColor] = useState(
		"#000000"
	);
    ...
    const [includeProfessionalSkills, setincludeProfessionalSkills] = useState(false);

    //skillsSectionComponent design
    const [
		skillsSectionComponentDesign,
		setskillsSectionComponentDesign,
	] = useState(0);
    const [
	...
	//cardborderSelected
	const [
		skillsCardBorderTypeSelected,
		setskillsCardBorderTypeSelected,
			...
			<div className="skillsSectionEditorMain">
				{displaySelected === 0 ? (
							...
							<div className="skillsSectionEditorTextsHeader">
								...
								<input
									...
									onChange={(event) => {
										dispatch({
											type:
												"skillsSectionHeaderChangeColor",
											payload: event.target.value,
										});
									}}
								></input>
					...
					<div className="skillsSectionEditCard">
						<p className="skillsSectionEditorHeader">Editing Card</p>
						<hr/>
					</div>
				) : null}
			</div>
